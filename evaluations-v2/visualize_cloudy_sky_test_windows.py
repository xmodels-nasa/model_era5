...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-target-ones", type=int, default=12)
    parser.add_argument("--min-pred-ones", type=int, default=1)
    parser.add_argument("--max-pred-ones", type=int, default=16)
    parser.add_argument("--max-pred-count-gap", type=float, default=6.0)
    parser.add_argument("--strict-gain-min", type=float, default=-0.15)
    parser.add_argument("--strict-gain-max", type=float, default=0.15)
    parser.add_argument("--min-tolerance-gain", type=float, default=0.05)
