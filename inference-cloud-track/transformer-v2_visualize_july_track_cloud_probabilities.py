#!/usr/bin/env python3
"""Visualize July track cloud labels/probabilities as ordered curtains."""
...
DEFAULT_INPUT = THIS_DIR / "outputs" / "data" / "transformer-v2_july_track_cloud_probabilities.nc"
